...
const deleteMe = document.getElementById("delete")
...
function newTextBox()
{
    ...
    addMeToo.addEventListener("click", function(){
    console.log(addMeToo.value)
...
deleteMe.addEventListener("click",newTextBox)
